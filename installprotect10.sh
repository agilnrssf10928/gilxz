    ...
    <div class="col-xs-12">
        ...
        <div class="alert alert-warning">
            ...
            <p style="margin-bottom: 0; font-size: 12px;">
                ...
                <span class="label label-success">@My_GilXz</span>
                <span class="label label-info">@My_GilXztesti3</span>
            </p>
        </div>
        @else
...
sed -i "s|@My_GilXztesti3|${CONTACT_TELEGRAM_2}|g" "$INDEX_FILE" 2>/dev/null || true
...
sed -i "s|Protected by: My_GilXz Tech|Protected by: ${BRAND_NAME}|g" "$INDEX_FILE" 2>/dev/null || true
